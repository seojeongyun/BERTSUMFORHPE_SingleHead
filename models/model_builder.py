...
class ExtSummarizer(nn.Module):
    def __init__(self, args, device, checkpoint):
        ...
        if checkpoint is not None:
            if 'pad_id' in checkpoint['model'].keys():
                del checkpoint['model']['pad_id']
            if 'sep_id' in checkpoint['model'].keys():
                del checkpoint['model']['sep_id']
            if 'cls_emb' in checkpoint['model'].keys():
                del checkpoint['model']['cls_emb']
